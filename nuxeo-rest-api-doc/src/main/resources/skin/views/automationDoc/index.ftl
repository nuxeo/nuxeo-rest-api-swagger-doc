...
<html>
  ...
  <style>
<#include "views/automationDoc/style.css" />
  </style>
  <body>
    <header role="banner">
      <h1>
    ...
    <div class="container">
      <#include "views/automationDoc/quicknav.ftl">
    </div>
    <div class="container">
      <section>
        <article role="contentinfo">
          ...
          <#if operation?has_content>
            <#include "views/automationDoc/operation.ftl">
          <#else>
            ...
            <div>
              ...
              <#else>
                ...
                <div>
                  <#include "views/automationDoc/menu.ftl" >
                </div>
              </#if>
            </div>
